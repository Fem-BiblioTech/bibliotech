    ...
    <div class="modal-content">
      ...
      <form action="/bibliotech/applications/save_book.php" method="POST" enctype='multipart/form-data'>
           ...
           <div class="col"><label for="author_name">Nombre del autor</label>
                <input type="text" name="author_name" id="author_name" class= "form-control" placeholder="Agrega el nombre" aria-label="Agrega el nombre">
              </div>
              <div class="col"><label for="author_lastName">Apellidos del autor</label>
              <input type="text" name="author_lastname" id="author_lastName" class= "form-control" placeholder="Agrega el apellido" aria-label="Agrega el apellido">
              </div>
           </div>
            
            <div class="form-group py-1"><label for="isbn">ISBN</label>
